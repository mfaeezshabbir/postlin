        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
          ...
          <div className="space-y-4">
            ...
            <Button
              ...
              disabled={loading}
              className="w-full flex items-center justify-center gap-3 bg-white hover:bg-gray-50 text-gray-900 font-semibold py-3.5 px-6 rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed border-2 border-gray-200"
            >
            ...
            {/* LinkedIn Sign-In (Optional - for later connection) */}
            <Button
              onClick={async () => {
                setLoading(true);
              ...
              disabled={loading}
              variant="outline"
              className="w-full flex items-center justify-center gap-3 text-[#0A66C2] border-[#0A66C2] hover:bg-blue-50 font-semibold py-3.5 px-6 rounded-xl transition-all duration-200"
            >
